...
<footer class="site-footer">
    <div class="site-container footer-grid">
        <div class="footer-summary">
            <span class="footer-kicker">From Quetta to market</span>
            ...
            <div class="footer-network-status"><i aria-hidden="true"></i><span>Local platform available</span></div>
        </div>
        <div class="footer-navigation">
            ...
            <nav class="footer-links" aria-label="Service links"><h2>Operations</h2><a href="<?= e(app_url('storage/index.php')) ?>">Cold storage</a><a href="<?= e(app_url('transport/index.php')) ?>">Transport network</a><a href="<?= e(app_url('contact.php')) ?>">Support and contact</a></nav>
            ...
            <nav class="footer-links" aria-label="Account links"><h2>Workspace</h2>
                ...
                <?php else: ?>
                    <a href="<?= e(app_url('auth/login.php')) ?>">Sign in</a><a href="<?= e(app_url('auth/recover.php')) ?>">Recover access</a>
                <?php endif; ?>
            </nav>
        </div>
    </div>
    <div class="site-container footer-bottom"><span>© <?= date('Y') ?> Quetta AgriLink. All rights reserved.</span><span>Built for practical agricultural commerce in Balochistan.</span></div>
</footer>
