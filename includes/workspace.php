    ...
    <section class="workspace workspace-role-<?= e($user['role_slug']) ?>">
        <aside class="workspace-sidebar">
            ...
            <form class="workspace-signout" method="post" action="<?= e(app_url('auth/logout.php')) ?>">
                ...
                <button type="submit"><span class="workspace-signout-icon" aria-hidden="true"></span><span class="workspace-signout-label">Sign out securely</span></button>
            </form>
        </aside>
