/** Orchard Ledger marketplace preview: field-led filtering, commercial context, and no fabricated social proof. */
...
export default function Marketplace() {
  ...
  return (
    <PreviewLayout>
      <PageHero eyebrow="Marketplace" title={<>Find harvest that is <i>trade-ready.</i></>} copy="Browse current supply with the product, origin, grade, available quantity, and price context needed before an offer." />
      <section className="market-page">
        <aside className="filter-rail">
          ...
          <p><MapPin size={14} /> Balochistan origins</p>
        </aside>
        <div className="market-results">
          <div className="market-results-head"><div><p className="eyebrow clay"><span /> Active listings</p><h2>Supply you can inspect.</h2></div><span>{visible.length} of {listings.length} entries</span></div>
